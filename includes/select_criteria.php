		...
		<div class="popupmain" style="float:left;">
			...
			<div class="formfield">
				<p class="row1">
					...
					<em> <?php
						$main_criteria = array('add_section' => 'Add new section', 'edit_section' => 'Edit / Delete section', 'select_section' => 'Select Section for Featured Posts');
	...
	<div class="featured_section" >
		...
		$featured = $secfeat_obj->mpo_query_section_name();
		if (!$featured) {
			$featured = 'No Featured Section has been selected';
		} else {
		?>
		<p><b>Current Selected Featured Section: </b><?php echo $featured;}	?>
		</p>
		</div>
	</div>
